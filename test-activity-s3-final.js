...
async function testActivityS3Final() {
  try {
    console.log('🧪 [TEST ACTIVITY S3 FINAL] Probando carga de actividades con imágenes a S3...\n');
    ...
    const testImagePath = path.join(__dirname, 'test-activity-final.jpg');
    ...
    formData.append('image', fs.createReadStream(testImagePath), {
      filename: 'test-activity-final.jpg',
    ...
    const activityData = {
      titulo: 'Actividad de prueba final con S3',
      participantes: [], // Array vacío para la prueba
      descripcion: 'Esta es una actividad de prueba final para verificar la carga de imágenes a S3 desde la app móvil',
      imagenes: [imageKey], // Array con el imageKey de S3
      accountId: selectedAccount._id, // Usar la cuenta real
      userId: user._id
    };
    ...
    console.log('\n🎉 [TEST ACTIVITY S3 FINAL] ¡Prueba completada exitosamente!');
    console.log('\n📋 Resumen:');
    console.log('   ✅ Login exitoso');
    console.log('   ✅ Cuenta válida obtenida');
    ...
    console.error('\n❌ [TEST ACTIVITY S3 FINAL] Error:', error.message);
    ...
    console.log('   5. Verificar que existan cuentas en la base de datos');
  }
}
